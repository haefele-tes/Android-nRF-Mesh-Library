...
import static no.nordicsemi.android.meshprovisioner.data.GenericTransitionTime.TRANSITION_TIME_BITS_LENGTH;
...
public class ScheduleEntry {
    ...
    public static final class Month extends EntryType {
        ...
        public static Month Value(int value) {
    ...
    public static final class DayOfWeek extends EntryType {
        ...
        public static DayOfWeek Value(int value) {
    ...
    public static final class Action extends EntryType {
        ...
        public static Action Value(int value) {
    ...
    public ScheduleEntry(BitReader bitReader) {
        ...
        scene = new Scene((int) bitReader.getBits(16));
        transitionTime = new GenericTransitionTime((int) bitReader.getBits(TRANSITION_TIME_BITS_LENGTH));
        action = new Action((int) bitReader.getBits(4));
        dayOfWeek = new DayOfWeek((int) bitReader.getBits(7));
        second = new Second((int) bitReader.getBits(6));
        minute = new Minute((int) bitReader.getBits(6));
        hour = new Hour((int) bitReader.getBits(5));
        day = new Day((int) bitReader.getBits(5));
        month = new Month((int) bitReader.getBits(12));
        year = new Year((int) bitReader.getBits(7));
    }

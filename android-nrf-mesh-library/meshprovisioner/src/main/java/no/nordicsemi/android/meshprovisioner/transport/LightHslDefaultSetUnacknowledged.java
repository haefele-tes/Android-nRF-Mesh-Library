...
public class LightHslDefaultSetUnacknowledged extends GenericMessage {

    private static final String TAG = LightCtlSet.class.getSimpleName();
    private static final int OP_CODE = ApplicationMessageOpCodes.LIGHT_HSL_DEFAULT_SET_UNACKNOWLEDGED;
    private static final int LIGHT_LIGHTNESS_SET_PARAMS_LENGTH = 6;
    ...
    public LightHslDefaultSetUnacknowledged(@NonNull final byte[] appKey,

...
public class GenericOnPowerUpSetUnacknowledged extends GenericMessage {

    private static final String TAG = GenericOnPowerUpSet.class.getSimpleName();
    private static final int OP_CODE = ApplicationMessageOpCodes.GENERIC_ON_POWER_UP_SET_UNACKNOWLEDGED;
     ...
     */
    public GenericOnPowerUpSetUnacknowledged(@NonNull final byte[] appKey, final int state) throws IllegalArgumentException {
        super(appKey);
        this.mState = state;

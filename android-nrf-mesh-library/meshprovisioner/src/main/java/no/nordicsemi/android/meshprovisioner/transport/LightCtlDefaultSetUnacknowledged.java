...
/**
 * To be used as a wrapper class when creating a LightCtlDefaultSetUnacknowledged message.
 */
@SuppressWarnings("unused")
public class LightCtlDefaultSetUnacknowledged extends GenericMessage {

    private static final String TAG = LightCtlDefaultSetUnacknowledged.class.getSimpleName();
    private static final int OP_CODE = ApplicationMessageOpCodes.LIGHT_CTL_DEFAULT_SET_UNACKNOWLEDGED;
    ...
    /**
     * Constructs LightCtlDefaultSetUnacknowledged message.
     *
    ...
    public LightCtlDefaultSetUnacknowledged(@NonNull final byte[] appKey,
